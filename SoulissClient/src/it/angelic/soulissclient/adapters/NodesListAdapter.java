...
public class NodesListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//holder.textTyp.setTextSize(TypedValue.COMPLEX_UNIT_SP,holder.textTyp.getTextSize() + opzioni.getListDimensTesto());
		...
		/* Icona del nodo */
		//if (nodi[position].getDefaultIconResourceId() != 0)
