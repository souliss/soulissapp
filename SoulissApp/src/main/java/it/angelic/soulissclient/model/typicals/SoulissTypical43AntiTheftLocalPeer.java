...
public class SoulissTypical43AntiTheftLocalPeer extends SoulissTypical implements ISoulissTypical {
	...
	public SoulissTypical43AntiTheftLocalPeer(SoulissPreferenceHelper fg) {
		super(fg);
	}
	...
	public void setOutputDescView(TextView textStatusVal) {
		...
		if (typicalDTO.getOutput() == Constants.Typicals.Souliss_T4n_Alarm ||
			...
			textStatusVal.setBackgroundDrawable(SoulissApp.getAppContext().getResources().getDrawable(R.drawable.borderedbackon));
		}
	}
	@Override
