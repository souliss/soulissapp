...
public final class PluginBundleManager {
     ...
     */
    public static final String BUNDLE_EXTRA_STRING_MESSAGE = "it.angelic.soulissclient.extra.STRING_MESSAGE"; //$NON-NLS-1$
    ...
    public static Bundle generateBundle(final Context context, final String message) {
        ...
        try {
            ...
            result.putInt(BUNDLE_EXTRA_INT_VERSION_CODE, packageInfo.versionCode);
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
            result.putInt(BUNDLE_EXTRA_INT_VERSION_CODE, 146);
        }
